...
# E_b->JPsi+E^- reconstruction done in module with coded fit
process.mkcands = cms.EDAnalyzer("JPsikaskeyPAT",
...
process.TFileService = cms.Service("TFileService",
   fileName = cms.string('output_parkedata2012_kaskey.root')
                          )
...
#process.schedule = cms.Schedule(process.filter, process.pat, process.ntup )
#process.schedule = cms.Schedule(process.gp,process.filter, process.pat, process.ntup )
